        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeycloakGroupId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tenants_KeycloakGroupId",
                table: "Tenants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_UserId_RoleName_TenantId",
                table: "UserRoles",
                columns: new[] { "UserId", "RoleName", "TenantId" },
                unique: true);
